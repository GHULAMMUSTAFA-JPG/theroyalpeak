...
export const SideComponent = ({ resentData }) => {
  return (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 ms-3">
                    <Link href="" className="d-block title text-dark fw-medium">
                      {item.title}
                    </Link>
...
export const BlogDetailContent = ({ blogData, commentsData }) => {
  return (
    <div className="col-lg-8 col-md-7">
      {/* Blog Content Image and Detail */}
      {/* -------------------------------------------------------- */}
      {/* -------------------------------------------------------- */}
      {/* -------------------------------------------------------- */}
      ...
      <div className="card border-0 shadow rounded-3 overflow-hidden">
        ...
        <div className="card-body">
          ...
          <p className="text-muted">
            ...
            European languages in Latin script. The advantage of its Latin
            origin and the relative meaninglessness of Lorum Ipsum is that the
            text does not attract attention to itself or distract the viewers
            attention from the layout.
          </p>
          <p className="text-muted">
            Thus, Lorem Ipsum has only limited suitability as a visual filler
            for German texts. If the fill text is intended to illustrate the
            characteristics of different typefaces, it sometimes makes sense to
            select texts containing the various letters and symbols specific to
            the output language.
          </p>
          ...
          <Link href="#" className="badge badge-link bg-primary ms-1">
            Minimal
          </Link>
          <Link href="#" className="badge badge-link bg-primary ms-1">
            Interior
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="commentor-detail">
                        <h6 className="mb-0">
                          <Link href="#" className="text-dark media-heading">
                            {item.name}
                          </Link>
                        </h6>
