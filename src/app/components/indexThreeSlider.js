                ...
                <div className="col-12">
                  <div className="title-heading text-start">
                    ...
                    <p className="para-desc text-white-50 title-dark mb-0 ">
                      The project is designed to offer a luxurious lifestyle
                      with a variety of amenities, including a swimming pool,
              ...
              <div className="row">
                <div className="col-12">
                  <div className="title-heading text-start">
                    ...
                    <p className="para-desc text-white-50 title-dark mb-0">
                      Azizi Mina, an example of luxury living with modern
                      designs and endless amenities available, is situated in
                      the core of Palm Jumeirah, one of Dubai’s most
                      sought-after locations. Azizi Developments has the
                      privilege to offer such an extraordinary opportunity to
                      own your houses nowhere but in Palm Jumeirah, in the Azizi
                      Mina.
                    </p>
